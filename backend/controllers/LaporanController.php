...
class LaporanController extends Controller
{
	...
	public function actionBypulang(){
	    return $this->render('bypulang');
	}
	public function actionBybayar(){
	    return $this->render('bybayar');
	}
	public function actionReport($start='', $end='', $cek='', $search='')
	{
		...
		$dataProvider = Rawatjalan::find()->where($where)->andWhere($andWhere)->andWhere($andFilterWhere)->groupby(['no_rekmed'])->all();
   ...
   public function actionPenerimaan($start='',$end='',$cek='',$search=''){
		return $this->render('penerimaan');
	}
	public function actionPenerimaanSearch($start='',$end='',$cek='',$search=''){
		return $this->renderAjax('penerimaan-search',[
		'start'=>$start,
		'end'=>$end,
		'search'=>$search,
		]);
	...
	public function actionPrint()
	{
        ...
        $content = $this->renderPartial('printpenerimaan');
	...
	public function actionPrintPengeluaran()
	{
		
        $content = $this->renderPartial('printpengeluaran');
