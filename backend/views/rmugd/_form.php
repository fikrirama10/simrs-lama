...
<div class="ert-form">
	...
	<div class='box box-body'>
		...
		<div class='row'>
				...
				<div class='col-md-3'><select id="ert-diagnosa" class="form-control" name='Rmugd[diagnosa]' aria-invalid="false">
			...
			<div class='row'>
				...
				<div class='col-md-3'>
				<?= $form->field($model, 'jampermintaan')->widget(TimePicker::classname(), [    'pluginOptions' => [
				'showSeconds' => true,
				'showMeridian' => false,
				'minuteStep' => 1,
				'secondStep' => 5,
				...
				<div class='col-md-3'><?= $form->field($model, 'jamdatang')->widget(TimePicker::classname(), [    'pluginOptions' => [
				'showSeconds' => true,
				'showMeridian' => false,
				'minuteStep' => 1,
				'secondStep' => 5,
