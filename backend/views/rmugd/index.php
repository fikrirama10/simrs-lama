...
$this->title = 'Waktu Tunggu Penyediaan Rekamedis Rawat Inap di UGD';
...
<div class="box box-body">
   ...
   <?php Pjax::begin(); ?>
				...
				'columns' => [
					...
					[
						'attribute' => 'Jam Permintaan Rawat Inap',
						'format' => 'raw',
						'hAlign'=>'center',
						'value' => function ($model, $key, $index) {
							
								return $model->jampermintaan;
							
						},
					],
					[
						'attribute' => 'Jam RM Datang',
						'format' => 'raw',
						'hAlign'=>'center',
						'value' => function ($model, $key, $index) {
							
								return $model->jamdatang;
...
<?php
$urlDataSearch = Url::to(['rmugd/get-search']);
$this->registerJs("
