...
<div class="ert-form">
	...
	<div class='box box-body'>
		...
		<div class='row'>
				...
				<div class='col-md-3'><select id="ert-diagnosa" class="form-control" name='Prosm[diagnosa]' aria-invalid="false">
			...
			<div class='col-md-3'></div>
				<div class='col-md-3'><?=$form->field($model, 'sm', [
					'template' => '{input}{label}{error}{hint}',
					'labelOptions' => ['class' => 'cbx-label']
					])->widget(CheckboxX::classname(), ['autoLabel'=>false])->label('Site Marking ?'); 
				?></div>
			</div>
		</div>
