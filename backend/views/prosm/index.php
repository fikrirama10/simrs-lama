...
/* @var $searchModel common\models\RmugdSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Presentase Kepatuhan Site Marking';
...
<div class="box box-body">
   ...
   <?php Pjax::begin(); ?>
				...
				'columns' => [
					...
					[
						'attribute' => 'Site Marking',
						'format' => 'raw',
						'hAlign'=>'center',
						'value' => function ($model, $key, $index) {
							if($model->sm == 1){
								return '<span class="label label-success">Dilakunan</span>';
							}else{
...
<?php
$urlDataSearch = Url::to(['prosm/get-search']);
$this->registerJs("
