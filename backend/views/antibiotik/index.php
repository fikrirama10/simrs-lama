...
$this->title = 'Kepatuhan Pemberian Antibiotik Profilaksis pada pasien Cito Operasi di UGD';
...
<div class="box box-body">
   ...
   <?php Pjax::begin(); ?>
				...
				'columns' => [
					...
					[
						'attribute' => 'Jenis Antibiotik Profilaksis',
						'format' => 'raw',
						'hAlign'=>'center',
						'value' => function ($model, $key, $index) {
							
								return $model->jenisae;
					...
					[
						...
						'hAlign'=>'center',
						'value' => function ($model, $key, $index) {
							if($model->dilakukan == 1){
								return '<span class="label label-success">Dilakukan</span>';
							}else{
								return '<span class="label label-danger">Tidak Dilakukan</span>';
							}
