...
<div class="ert-form">
	...
	<div class='box box-body'>
		...
		<div class='row'>
				...
				<div class='col-md-3'><select id="ert-diagnosa" class="form-control" name='Antibiotik[diagnosa]' aria-invalid="false">
			
				</select></div>
			</div>
			<div class='row'>
				<div class='col-md-3 formright'>Jenis Antibiotik</div>
				<div class='col-md-6'><?= $form->field($model, 'jenisae')->textInput(['maxlength' => true])->label(false) ?>
				</div>
				
		</div>
			<div class='row'>
			<div class='col-md-3'></div>
				<div class='col-md-3'><?=$form->field($model, 'dilakukan', [
					'template' => '{input}{label}{error}{hint}',
					'labelOptions' => ['class' => 'cbx-label']
					])->widget(CheckboxX::classname(), ['autoLabel'=>false])->label('Dilakukan ?'); 
				?></div>
			</div>
		</div>
