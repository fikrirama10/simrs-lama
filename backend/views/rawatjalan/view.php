...
$lab = Orderlab::find()->where(['idrawat'=> $model->idrawat])->one();
$labc = Orderlab::find()->where(['idrawat'=> $model->idrawat])->count();
$this->title = $model->id;
	...
	<div class='container-fluid' style='margin-top:20px;'>
		...
		<div class='box box-body'>
			<?= Html::a('Print Label', ['label', 'id' => $model->id], ['class' => 'btn btn-primary btn-sm pt-10','target' => '_blank']) ?>
						<?= Html::a('Print Form', ['fp', 'id' => $model->id], ['class' => 'btn btn-warning btn-sm pt-10','target' => '_blank']) ?>
						<?= Html::a('Input SEP', ['insep', 'id' => $model->id], ['class' => 'btn btn-success btn-sm pt-10','target' => '_blank']) ?>
						<hr>
