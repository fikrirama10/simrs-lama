...
<div class="pemeriksaan-igd-form box">
		...
		<h3>Update data</h3>
			...
			<div class='col-md-6'>
				...
				<h5>Anamnesa</h5>
				<?php }?>
				<textarea type='text' id="PemeriksaanRajal-pemeriksaan" class='form-control' placeholder='Pemeriksa Dokter' rows='6' name='PemeriksaanRajal[pemeriksaan]' value=''><?= $model->pemeriksaan ?></textarea>	
				<hr>
			...
			<div class='col-md-6'>
			 ...
			 <?= $form->field($model, 'katgigi')->dropDownList(ArrayHelper::map(KategoriTindakan::find()->all(), 'id', 'kategori'),['prompt'=>'- Pilih Pengobatan -','onchange'=>'$.get("'.Url::toRoute('pemeriksaan-rajal/list-pengobatan/').'",{ id: $(this).val() }).done(function( data ) 
				...
				<div class='row'>
					<div class='col-md-6'>
						<div class="input-group">
						<input type='text' class='form-control' placeholder='Tekanan Darah' name='PemeriksaanRajal[td]' value='<?= $model->td ?>' id="PemeriksaanRajal-td"><span class="input-group-addon" id="basic-addon1">mmHg</span>
						</div>
					</div>
					<div class='col-md-6'>
						<div class="input-group">
						<input type='text' class='form-control' placeholder='Nadi' name='PemeriksaanRajal[nadi]' value='<?= $model->nadi ?>' id="PemeriksaanRajal-nadi"><span class="input-group-addon" id="basic-addon1">x / menit</span>
						</div>
					</div>
					<div class='col-md-6'>
						<div class="input-group">
						<input type='text' class='form-control' placeholder='Respirasi' name='PemeriksaanRajal[respirasi]'value='<?= $model->respirasi ?>' id="PemeriksaanRajal-respirasi"><span class="input-group-addon" id="basic-addon1">x / menit</span>
						</div>
					</div>
					<div class='col-md-6'>
						<div class="input-group">
						<input type='text' class='form-control' value='<?= $model->suhu ?>' placeholder='Suhu' name='PemeriksaanRajal[suhu]' id="PemeriksaanRajal-suhu"><span class="input-group-addon" id="basic-addon1">C</span>
						</div>
					</div>
				</div>
				<hr>
