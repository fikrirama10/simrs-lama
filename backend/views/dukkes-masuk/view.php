...
$detail = DukkesMasukDetail::find()->where(['kodetrx'=>$model->kodetrx])->all();
$this->title = $model->id;
...
<div class="dukkes-keluar-view">
	<div class='box box-body'>
		<div class='row'>
		<div class='col-md-6'>
		<h3>Pemasukan Obat / Alkes Dukkes</h3><hr>
		<?= DetailView::widget([
			'model' => $model,
			'attributes' => [
			...
			<div class='col-md-8'>
				...
				<table class='table table-responsive'>
					...
					<tr>
						...
						<td><a href='<?= Url::to(['dukkes-masuk/hapus-obat?id='.$al->id])?>' data-confirm="Are you sure ?" class='label label-danger'>-</td>
					</tr>
					<?php endforeach; ?>
				</table>
				<a id="confirm" href='<?= Url::to(['dukkes-masuk/selesai?id='.$model->id])?>' class="btn btn-success pull-left">Selesai</a>			
			</div>			
		</div>
		<?php }else{ ?>
		<div class='row'>
