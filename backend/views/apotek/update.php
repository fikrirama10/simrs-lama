...
<div class="ert-form">
	...
	<h3>Tambah Obat</h3><hr>
		...
		<div class='row'>
		    <div class='col-md-3 formright'>Stok Minimal</div>
				<div class='col-md-3'><?= $form->field($model, 'mstok')->TextInput(['maxlength' => true,])->label(false) ?>
				</div>
		    
		</div>
			<div class='row'>
			<div class='col-md-3 formright'>ED</div>
			...
			<div class='row'>
				...
				<div class='col-md-3'>
				<?= $form->field($model, 'idkat')->dropDownList(ArrayHelper::map(Katbobat::find()->all(), 'id', 'kat'),['prompt'=>'- Kategori  -'])->label('',['class'=>'label-class'])->label(false)?>
				</div>
			</div>
