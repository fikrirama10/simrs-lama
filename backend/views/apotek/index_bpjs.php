...
<div class="articles-index">
	<div class='panel panel-default'>
		<div class='panel-body'>
			...
			<?php  echo $this->render('_searchbpjs', ['model' => $searchModel]); ?>
            <?= Html::a("<i class='fa fa-print'></i> Print Barang", ['print-bpjs'], ['class' => 'btn btn-warning  mbot10','target'=>'_blank']) ?>
			<p>
