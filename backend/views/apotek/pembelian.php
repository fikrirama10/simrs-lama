...
<div class="customer-form">
    ...
    <div class="row">
		...
		<h4>Pembelian </h4><hr>
			<div class='row'>
				<div class ='col-md-4 formright'>No Faktur</div>
				<div class ='col-md-8'>
            <?= $form->field($radid, 'nofaktur')->textInput(['maxlength' => true])->label(false) ?></div>
			</div>
			...
			<div class='row'>
				<div class ='col-md-4 formright'>Suplier</div>
				<div class ='col-md-8'><?= $form->field($radid, 'idsup')->dropDownList(ArrayHelper::map(Suplier::find()->all(), 'id', 'namasuplier'))->label(false)?></div>
			</div>
			<div class='row'>
				<div class ='col-md-4 formright'>Total Harga</div>
				<div class ='col-md-8'>
            <?= $form->field($radid, 'total')->textInput(['maxlength' => true])->label(false) ?></div>
			</div><hr>
					<div class='row'>
				<div class ='col-md-4 formright'>Total Bayar</div>
				<div class ='col-md-8'>
            <?= $form->field($radid, 'bayar')->textInput(['maxlength' => true])->label(false) ?></div>
			</div>
                ...
                <div class="item panel panel-default"><!-- widgetBody -->
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
							...
							<div class='col-md-3'>
								 <?= $form->field($raddetail,  "[{$index}]harga")->textInput() ?>
							</div>
