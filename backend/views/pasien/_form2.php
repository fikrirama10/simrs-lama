...
use kartik\date\DatePicker;use yii\web\JsExpression;
$formatJs = <<< 'JS'
		...
		<div class='row'>
			<div class='col-md-8'>
				...
				<div class='row'>
					...
					<div class='col-md-8'><?= $form->field($model, 'nobpjs',['inputOptions' => ['autofocus' => 'autofocus', 'class' => 'form-control', 'tabindex' => '1']])->textInput(['placeholder' => "Di isi jika pasien bpjs daftar secara manual"],['maxlength' => true])->label(false) ?></div>
				...
				<div class='row'>
					...
					<div class='col-md-8'><?= $form->field($model, 'nama_pasien',['inputOptions' => ['autofocus' => 'autofocus', 'class' => 'form-control', 'tabindex' => '1']])->textInput(['placeholder' => "Nama Pasien"],['maxlength' => true])->label(false) ?></div>
					<div class='col-md-2'>
