...
<div class="ert-form">
	...
	<div class='box box-body'>
		...
		<div class='row'>
				...
				<div class='col-md-3'><select id="ert-diagnosa" class="form-control" name='Karj[diagnosa]' aria-invalid="false">
			
				</select></div>
			</div>
			
			<div class='row'>
			<div class='col-md-3 formright'>Resiko</div>
				<div class='col-md-3'><?=$form->field($model, 'lengkap', [
					'template' => '{input}{label}{error}{hint}',
					'labelOptions' => ['class' => 'cbx-label']
					])->widget(CheckboxX::classname(), ['autoLabel'=>false])->label('Lengkap'); 
				?></div>
			</div>
		</div>
