...
$this->title = 'Kelengkapan Pengisian Rekam Medis 1 x 24 jam';
...
<div class="box box-body">
   ...
   <?php Pjax::begin(); ?>
				...
				'columns' => [
					...
					[
						'attribute' => 'Tanggal Pasien Pulang',
						'format' => 'raw',
						
						'value' => function ($model, $key, $index) { 
							return $model->tglpulang;
						},
					],
					[
						'attribute' => 'Tanggal Status Kembali',
						'format' => 'raw',
						
						'value' => function ($model, $key, $index) { 
							return $model->tglskembali;
						},
					],
					// [
						// 'attribute' => 'Anamesis',
					...
					[
						'attribute' => 'Pengembalian RM setelah 1 x 24 jam',
						'format' => 'raw',
						'hAlign'=>'center',
						'value' => function ($model, $key, $index) {
							if($model->pengembalian == 1){
					...
					[
						'attribute' => 'Kelengkapan RM setelah 1 x 24 jam',
						'format' => 'raw',
						'hAlign'=>'center',
						'value' => function ($model, $key, $index) {
...
<?php
$urlDataSearch = Url::to(['antibiotik/get-search']);
$this->registerJs("
