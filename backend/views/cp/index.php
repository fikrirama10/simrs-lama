...
$this->title = '=> Kepatuhan DPJP terhadap Pelaksanaan Clinical Pathway dengan diagnosa Apendik Akut (SpB), Persalinan SC (SpOG), Demam Typoid (SpD), GEA dan DHF gr 1&2 (SpA)  di UGD';
...
<?php
$urlDataSearch = Url::to(['cp/get-search']);
$this->registerJs("
