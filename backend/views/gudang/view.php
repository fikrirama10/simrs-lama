...
$mutasi = Apotekmutasi::find()->where(['idobat'=>$model->id])->all();
$jumlah = $model->stok + $model->stokgudang;
$no = 1;
?>
<div class='box box-body'>
<a>Nama Barang</a>
<h4><?= $model->namaobat?> (<?= $jumlah ?> <?= $model->satuan->satuan?>)</h4>
<p>Stok di Gudang : <?= $model->stokgudang?> || Stok di Apotek : <?= $model->stok?></p>
<hr>
<p>Mutasi Stok</p>
