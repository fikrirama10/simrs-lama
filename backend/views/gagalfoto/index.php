...
$gagal = Gagalfoto::find()->all();
$this->title = 'Kegagalan Foto';
...
<div class="box box-body">
   ...
   <?php Pjax::begin(); ?>
				...
				'columns' => [
					...
					[
						'attribute' => 'Jenis Foto yang gagal',
						'format' => 'raw',
						'hAlign'=>'center',
						'value' => function ($model, $key, $index) {
							return $model->pecah($model->jenisfoto);
