...
$this->title = 'Emergency Respon Time';
...
<div class="box box-body">
    ...
    <p>
        <?= Html::a('Create Ert', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
	<?php
   ...
   <?php Pjax::begin(); ?>
				...
				'columns' => [
					...
					[
						'attribute' => 'Jam Dilayani',
						'format' => 'raw',
						'hAlign'=>'center',
						'value' => function ($model, $key, $index) {
							
								return $model->jamdilayani;
...
<?php
$urlDataSearch = Url::to(['ert/get-search']);
$this->registerJs("
