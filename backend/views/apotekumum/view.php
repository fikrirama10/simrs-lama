...
<div class='container-fluid'>
						...
						<div class='row'>
							...
							<div class='col-md-10'>
								<?= $form->field($resep, 'idobat')->widget(Select2::classname(), [
									...
									'ajax' => [
									'url' => Yii::$app->params['baseUrl'].'/apites/list-obat-umum',
									'dataType' => 'json',
									'delay' => 250,
	...
	<div class='box box-footer'>
		<a href='<?= Yii::$app->params['baseUrl'].'/dashboard/apotekumum/selesai/'.$model->id?>'  class='btn btn-success btn-md'>Selesai</a>
	</div>
	</div>
	<?php } ?>
</div>