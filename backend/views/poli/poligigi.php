                  ...
                  <li>
                    ...
                    <div class="timeline-item">
                      ...
                      <div class="timeline-footer">
                        <a href='<?= Yii::$app->params['baseUrl'].'/dashboard/asesmen/awalgigi/'.$a->id?>' class="btn btn-success btn-xs">Periksa</a>
                        <a class="btn btn-warning btn-xs">Poli Gigi</a>
                      </div>
                    </div>
                  </li>
				  <li>
