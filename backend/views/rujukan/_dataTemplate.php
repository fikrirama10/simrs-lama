...
<?php
$urlDataBarangmd = Url::to(['rujukan/get-data-pasien']);
$urlDataBsSearch = Url::to(['rujukan/getsb']);
		...
		$.ajax({
			...
			success: function (data) {
				if(data !== null){
					...
					$('#rujukan-no_rekmed').val(res.no_rekmed);
					$('#rujukan-nama').val(res.nama_pasien);
					$('#rujukan-usia').val(res.usia);
