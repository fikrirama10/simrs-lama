...
<div class="ert-form">
	...
	<div class='box box-body'>
		...
		<div class='row'>
				<div class='col-md-3 formright'>Dinas</div>
				<div class='col-md-3'>
				<?= $form->field($model, 'dinas')->dropDownList(ArrayHelper::map(Dinas::find()->all(), 'id', 'dinas'),['prompt'=>'- Dinas -'])->label(false)?>
				</div>
