...
$tni = Mcutni::find()->where(['between','id',101,199])->all();
?>
<?php foreach($tni as $t): ?>
  ...
  <div class = 'hea0'>
    ...
    <div class = 'hea0'>
	 ...
	 <div class = 'hea0'>
		...
		<?php }else if($t->id == 80){?>
		Microcardia (CTR 31%)
		<?php }else if($t->id == 124){?>
		Fusi os costa 1- 2 kiri
		<?php }else if($t->id == 118){?>
		Hipoplasia costa 1 kiri
		<?php }else{ ?>
 ...
 <div class = 'hea0' style='margin-top:50px;'>
	...
	<?php if($t->id == 11){?>
		U : 4
		<?php }else if($t->id == 40 || $t->id == 124){ ?>
		U : 4
		<?php }else if($t->id == 66){?>
		U : 4
		<?php }else if($t->id == 80){?>
		U : 4
		<?php }else if($t->id == 251 || $t->id == 118){?>
		U : 2
		<?php }else{ ?>
		U : 1
		<?php } ?>
