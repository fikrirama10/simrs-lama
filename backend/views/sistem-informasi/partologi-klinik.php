...
?>
	...
	<div class="col-sm-5">
				...
				<div class='col-md-3'> 
					<a href="laporan-lab?start=<?= $start ?>&end=<?= $end ?>&cek=<?= $cek ?>" target="_blank" id="print_pdf" class="btn btn-danger" style='margin-top:22px;'><i class="fa fa-print" style="width:20px"></i>Print Pdf</a> 
				</div> 
	...
	<div class='box box-body'>
	    <h3>PEMERIKSAAN PATOLOGI KLINIK</h3><hr>
	<div class='row'>
...
<?php
$urlDataSearch = Url::to(['sistem-informasi/get-partologi-klinik']);
$this->registerJs("
	...
	$('#start_date').on('change',function(){
		...
		$('#print_pdf').attr('href', 'laporan-lab?start='+start+'&end='+end+'&cek=custom&search='+$('#textsearch').val());
	});
