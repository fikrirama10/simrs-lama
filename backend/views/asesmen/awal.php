		...
		<div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="tab_1-1">
				...
				<?= $form->field($model, 'diagket')->dropDownList([ 'TB+' => 'TB+','SUSPTB'=>'SUSPTB', 'B20' => 'B20', ], ['prompt' => 'Keterangan Diagnosa'])->label(false) ?>
				<?= $form->field($model, 'ketdiag')->dropDownList([ 'KB' => 'Kasus Baru','KL'=>'Kasus Lama' ])->label(false) ?>
