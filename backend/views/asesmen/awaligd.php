...
<?= $form->field($model, 'iddokter')->dropDownList(ArrayHelper::map(Dokter::find()->where(['idpoli'=>6])->all(), 'id', 'namadokter'),['prompt'=>'- Pilih Dokter -'])->label('Dokter',['class'=>'label-class'])->label("Dokter Pemeriksa")?>
	...
	<div class='col-md-4'>
		<div class="box box-primary">
			...
			<hr>
              ...
              <p class="text-muted">
				<?php if($model->hubungan == null ){echo"";}else{ ?><?= $model->penanggung?> (Hubungan <?= $model->hub->hubungan?>)<?php } ?></p>
	...
	<div class='col-md-8'>
		<div class="nav-tabs-custom">
			...
			<?= $form->field($model, 'kdiagnosak')->textinput(['placeholder' => 'KODE DIAGNOSA','onkeyup'=>'$.get("'.Url::toRoute('tes/listdiagnosa/').'",{ id: $(this).val() }).done(function( data ) 
				...
				<select id="diagnosaranap-kdiagnosa" class="form-control" name='Rawatjalan[kdiagnosa]' aria-invalid="false">
