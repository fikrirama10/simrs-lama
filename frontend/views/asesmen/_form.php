...
<?= $form->field($model, 'iddokter')->dropDownList(ArrayHelper::map(Dokter::find()->all(), 'id', 'namadokter'),['prompt'=>'- Pilih Dokter -'])->label('Dokter',['class'=>'label-class'])->label("Dokter Pemeriksa")?>
...
<div class='row'>
	<div class='col-md-4'>
		<div class="box box-primary">
			...
			<?php if($pekerjaan == false ){echo" <h3>Belum PPI</h3> <div class='timeline-footer'></div>";}else{ ?>
	...
	<div class='col-md-8'>
	    ...
	    <?= $form->field($model, 'klab')->textinput(['placeholder' => 'KODE DIAGNOSA','onkeyup'=>'$.get("'.Url::toRoute('tes/listdiagnosa/').'",{ id: $(this).val() }).done(function( data ) 
               ...
               <h3>Diagnosa</h3>
				...
				<?= $form->field($model, 'kdiagnosa')->textinput(['placeholder'=>'']) ?>
              </div>
