		...
		<div class="box-header">
			...
			?>
				...
				<select  class="form-control" name='textsearch' id='textsearch' form='carform'>
									...
									<option value="<?= $b->id ?>"><?= $r->namakelas ?></option>
									<?php endforeach; ?>
						</select>
				</div>
				...
				<div class="col-sm-3">
					<a href="rawatinap?start=<?= $start ?>&end=<?= $end ?>&cek=<?= $cek ?>" id="cek" class="btn btn-warning mup25" style="display:none;">Apply Filter</a>
					  <!-- radio -->
...
<?php
$urlDataSearch = Url::to(['rawatjalan/get-ranap']);
$this->registerJs("
