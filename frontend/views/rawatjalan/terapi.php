...
$labc = Lab::find()->where(['idrawat'=>$model->idrawat])->count();
?>   
   ...
   <div class="row">
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="tab_3-2">
                 <a href='<?= Yii::$app->params['baseUrl'].'/dashboard/rawatjalan/lab/'.$model->id?>' class="btn btn-success btn-md">Laboratorium</a>
                 <a href='<?= Yii::$app->params['baseUrl'].'/dashboard/rawatjalan/lab/'.$model->id?>' class="btn btn-warning btn-md">Radiologi</a>
				  <a href='<?= Yii::$app->params['baseUrl'].'/dashboard/asesmen/igdrawat/'.$model->id?>' class="btn btn-danger btn-md">Rawat </a>
	...
	<div class='col-md-4'>
		<div class="box box-primary">
		  ...
		  <a href='<?= Yii::$app->params['baseUrl'].'/dashboard/rawatjalan/selesai/'.$model->id?>' class="btn btn-primary pull-right">Simpan</a>	
<?php } ?>		  
			</div>
            <!-- /.box-body -->
          </div>
