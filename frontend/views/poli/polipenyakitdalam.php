          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <div class="active  tab-pane" id="timeline">
                <!-- The timeline -->
				<h3>Pasien Poli Penyakit dalam</h3><hr>
                  ...
                  <li>
                    ...
                    <div class="timeline-item">
                      ...
                      <div class="timeline-footer">
                        <a href='<?= Yii::$app->params['baseUrl'].'/dashboard/asesmen/awaldalam/'.$a->id?>' class="btn btn-success btn-xs">Periksa</a>
                        <a class="btn btn-warning btn-xs">Poli bedah</a>
                      </div>
                    </div>
                  </li>
				  <li>
