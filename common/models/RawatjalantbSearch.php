 ...
 */
class RawatjalantbSearch extends Rawatjalan
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id',  'iddokter', 'idpoli', 'idbayar'], 'integer'],
            [['idrawat','no_rekmed', 'tgldaftar', 'penanggung', 'alamat_penanggung', 'hubungan', 'notlp'], 'safe'],
        ];
    }
    ...
    {
        $query = Rawatjalan::find()->orderBy(['tgldaftar'=>SORT_DESC])->groupBy('no_rekmed');
