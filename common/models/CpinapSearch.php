...
/**
 * CpinapSearch represents the model behind the search form of `common\models\Cpinap`.
 */
class CpinapSearch extends Cpinap
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'patuh', 'validator'], 'integer'],
            [['no_rekmed', 'diagnosa', 'tenagakesehatan', 'tanggal'], 'safe'],
        ];
    }
    ...
    public function search($params, $where=null, $andWhere=null,$andWhere2=null, $andFilterWhere=null, $andFilterWhere2=null, $orderBy = null)
    {
        ...
        $query->andFilterWhere(['like', 'no_rekmed', $this->no_rekmed])
            ...
            ->andFilterWhere(['like', 'tenagakesehatan', $this->tenagakesehatan]);
