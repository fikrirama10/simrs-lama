...
class Rxfisik extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['tinggibadan', 'beratbadan','rx_fisik', 'gizi', 'suhu'], 'string'],
            [[ 'kesadaran', 'keadaan','idtkp'], 'integer'],
    ...
    public function attributeLabels()
    {
		...
		public function getKesadarann()
    {
        return $this->hasOne(Kesadaran::className(), ['id' => 'kesadaran']);
    }
}
