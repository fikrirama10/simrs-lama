...
/**
 * AntibiotikSearch represents the model behind the search form of `common\models\Antibiotik`.
 */
class AntibiotikSearch extends Antibiotik
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'dilakukan'], 'integer'],
            [['tanggal', 'no_rekmed', 'idrawat', 'diagnosa', 'jenisae'], 'safe'],
        ];
    }
    ...
    public function search($params, $where=null, $andWhere=null,$andWhere2=null, $andFilterWhere=null, $andFilterWhere2=null, $orderBy = null)
    {
        ...
        $query->andFilterWhere(['like', 'no_rekmed', $this->no_rekmed])
            ...
            ->andFilterWhere(['like', 'jenisae', $this->jenisae]);
