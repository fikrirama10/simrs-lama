...
/**
 * GelangSearch represents the model behind the search form of `common\models\Gelang`.
 */
class GelangSearch extends Gelang
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['tanggal', 'no_rekmed', 'diagnosa', 'df', 'kepatuhan'], 'safe'],
        ];
    }
    ...
    public function search($params, $where=null, $andWhere=null,$andWhere2=null, $andFilterWhere=null, $andFilterWhere2=null, $orderBy = null)
    {
        ...
        $query->andFilterWhere(['like', 'no_rekmed', $this->no_rekmed])
            ...
            ->andFilterWhere(['like', 'kepatuhan', $this->kepatuhan]);
