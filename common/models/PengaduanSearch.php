...
/**
 * PengaduanSearch represents the model behind the search form of `common\models\Pengaduan`.
 */
class PengaduanSearch extends Pengaduan
{
    ...
    {
        return [
            [['id', 'idjenispengaduan'], 'integer'],
            [['nomer', 'nama', 'email', 'nohp', 'pengaduan', 'tgl'], 'safe'],
        ];
    }
