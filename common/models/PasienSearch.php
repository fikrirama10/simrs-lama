...
class PasienSearch extends pasien
{
    ...
    {
        return [
            [['no_rekmed','id_status', 'created_at', 'nobpjs','idverifed'], 'integer'],
            [['tempat_lahir', 'nama_pasien', 'jenis_kelamin', 'gol_darah', 'nohp', 'alamat', 'tanggal_lahir'], 'safe'],
        ];
    }
     ...
     */
    public function search($params,$where=null, $andWhere=null,$where2=null, $andFilterWhere=null, $andFilterWhere2=null, $orderBy = null)
    {
        $query = pasien::find()->orderby(['no_rekmed' => SORT_DESC]);
