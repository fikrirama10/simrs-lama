...
/**
 * TransferpasienSearch represents the model behind the search form of `common\models\Transferpasien`.
 */
class TransferpasienSearch extends Transferpasien
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'validator', 'kepatuhan'], 'integer'],
            [['no_rekmed', 'tanggal', 'diagnosa', 'df'], 'safe'],
        ];
    }
