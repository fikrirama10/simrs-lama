...
/**
 * RmugdSearch represents the model behind the search form of `common\models\Rmugd`.
 */
class RmugdSearch extends Rmugd
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'df', 'sesuai'], 'integer'],
            [['tanggal', 'no_rekmed', 'diagnosa', 'jampermintaan', 'jamdatang'], 'safe'],
        ];
    }
    ...
    public function search($params, $where=null, $andWhere=null,$andWhere2=null, $andFilterWhere=null, $andFilterWhere2=null, $orderBy = null)
    {
        ...
        $query->andFilterWhere([
            ...
            'df' => $this->df,
            'jampermintaan' => $this->jampermintaan,
